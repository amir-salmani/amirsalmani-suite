...
const BackFace = () => (
    <div
        className="border border-[var(--fg)]/15 h-[500px] w-full absolute rounded-3xl top-0 left-0 flex items-center justify-center bg-[var(--bg)] text-[var(--fg)] font-bold text-7xl"
