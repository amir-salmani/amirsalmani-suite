...
const buttonVariants = cva(
	"inline-flex items-center justify-center dark:bg-[color-mix(in_srgb,var(--fg)_55%,var(--bg))] dark:text-[var(--fg)] whitespace-nowrap text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 relative bg-primary text-primary-foreground hover:bg-primary/90 border border-primary/50 shadow-md before:absolute before:inset-0 before:border-t before:border-[var(--fg)]/40 before:bg-gradient-to-b before:from-[var(--fg)]/20 before:to-transparent cursor-pointer transition-transform duration-200 active:scale-[0.96] subpixel-antialiased gap-2",
	{
		variants: {
			variant: {
				default: "",
