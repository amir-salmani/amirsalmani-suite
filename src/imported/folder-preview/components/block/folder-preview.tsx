...
> = {
    devi: {
        back: "text-[color-mix(in_srgb,var(--fg)_55%,var(--bg))]",
        cover: "text-[color-mix(in_srgb,var(--fg)_71%,var(--bg))]",
        deco: "text-[color-mix(in_srgb,var(--fg)_71%,var(--bg))] brightness-125",
        caption: "text-[color-mix(in_srgb,var(--fg)_28%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_92%,var(--bg))]",
        bg: "bg-[color-mix(in_srgb,var(--fg)_97%,var(--bg))] dark:bg-[color-mix(in_srgb,var(--fg)_21%,var(--bg))]",
    },
    rudras: {
        back: "text-[color-mix(in_srgb,var(--fg)_37%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_45%,var(--bg))]",
        cover: "text-[color-mix(in_srgb,var(--fg)_45%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_55%,var(--bg))]",
        deco: "text-[color-mix(in_srgb,var(--fg)_71%,var(--bg))]",
        caption: "text-[color-mix(in_srgb,var(--fg)_45%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_71%,var(--bg))]",
        bg: "bg-[color-mix(in_srgb,var(--fg)_92%,var(--bg))] dark:bg-[color-mix(in_srgb,var(--fg)_28%,var(--bg))]",
    },
    ardra: {
        back: "text-[color-mix(in_srgb,var(--fg)_28%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_37%,var(--bg))]",
        cover: "text-[color-mix(in_srgb,var(--fg)_45%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_55%,var(--bg))]",
        deco: "text-[color-mix(in_srgb,var(--fg)_37%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_45%,var(--bg))]",
        caption: "text-[color-mix(in_srgb,var(--fg)_55%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_71%,var(--bg))]",
        bg: "bg-[color-mix(in_srgb,var(--fg)_28%,var(--bg))] dark:bg-[color-mix(in_srgb,var(--fg)_14%,var(--bg))]",
    },
    shakti: {
        back: "text-[color-mix(in_srgb,var(--fg)_28%,var(--bg))]",
        cover: "text-[color-mix(in_srgb,var(--fg)_37%,var(--bg))]",
        deco: "text-[color-mix(in_srgb,var(--fg)_28%,var(--bg))]",
        caption: "text-[color-mix(in_srgb,var(--fg)_71%,var(--bg))]",
        bg: "bg-[color-mix(in_srgb,var(--fg)_45%,var(--bg))] dark:bg-[color-mix(in_srgb,var(--fg)_28%,var(--bg))]",
    },
    kubera: {
        back: "text-[color-mix(in_srgb,var(--fg)_21%,var(--bg))]",
        cover: "text-[color-mix(in_srgb,var(--fg)_37%,var(--bg))]",
        deco: "text-[color-mix(in_srgb,var(--fg)_45%,var(--bg))]",
        caption: "text-[color-mix(in_srgb,var(--fg)_21%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_97%,var(--bg))]",
        bg: "bg-[color-mix(in_srgb,var(--fg)_71%,var(--bg))] dark:bg-[color-mix(in_srgb,var(--fg)_45%,var(--bg))]",
    },
    hari: {
        back: "text-[color-mix(in_srgb,var(--fg)_28%,var(--bg))]",
        cover: "text-[color-mix(in_srgb,var(--fg)_37%,var(--bg))]",
        deco: "text-[color-mix(in_srgb,var(--fg)_28%,var(--bg))]",
        caption: "text-[color-mix(in_srgb,var(--fg)_71%,var(--bg))]",
        bg: "bg-[color-mix(in_srgb,var(--fg)_55%,var(--bg))] dark:bg-[color-mix(in_srgb,var(--fg)_37%,var(--bg))]",
    },
    ravi: {
        back: "text-[color-mix(in_srgb,var(--fg)_21%,var(--bg))]",
        cover: "text-[color-mix(in_srgb,var(--fg)_37%,var(--bg))]",
        deco: "text-[var(--bg)] dark:text-[var(--fg)]",
        caption: "text-[color-mix(in_srgb,var(--fg)_21%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_97%,var(--bg))]",
        bg: "bg-[color-mix(in_srgb,var(--fg)_92%,var(--bg))] dark:bg-[color-mix(in_srgb,var(--fg)_28%,var(--bg))]",
    },
    durga: {
        back: "text-[color-mix(in_srgb,var(--fg)_45%,var(--bg))]",
        cover: "text-[color-mix(in_srgb,var(--fg)_55%,var(--bg))]",
        deco: "text-[color-mix(in_srgb,var(--fg)_45%,var(--bg))]",
        caption: "text-[color-mix(in_srgb,var(--fg)_71%,var(--bg))] font-mono",
        bg: "bg-[color-mix(in_srgb,var(--fg)_21%,var(--bg))] dark:bg-[var(--bg)]",
    },
    nandi: {
        back: "text-[color-mix(in_srgb,var(--fg)_55%,var(--bg))]",
        cover: "text-[color-mix(in_srgb,var(--fg)_71%,var(--bg))]",
        deco: "text-[color-mix(in_srgb,var(--fg)_55%,var(--bg))]",
        caption: "text-[color-mix(in_srgb,var(--fg)_21%,var(--bg))] dark:text-[color-mix(in_srgb,var(--fg)_97%,var(--bg))]",
        bg: "bg-[color-mix(in_srgb,var(--fg)_97%,var(--bg))] dark:bg-[color-mix(in_srgb,var(--fg)_14%,var(--bg))]",
    },
};
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
                {images.map((img, i) => (
                    <motion.img
                        ...
                        src={img}
                        alt=""
                        className="absolute w-12 h-12 object-cover rounded-full border-2 border-[var(--fg)] shadow-md"
            ...
            <div className="relative cursor-pointer aspect-[20/16]" style={{ perspective: "800px" }}>
                ...
                <motion.div
                    className={cn(
                        ...
                        isHovered ? "text-[color-mix(in_srgb,var(--fg)_45%,var(--bg))]" : colors.cover
                    )}
                >
                    <FolderCoverIcon />
                    <div
    ...
    return (
        <div className="relative">
            ...
            <div className="relative cursor-pointer aspect-[20/16]" style={{ perspective: "800px" }}>
                ...
                {/* Paper Sheet Deco */}
                <div className="absolute bottom-0.5 left-0.5 right-0.5 h-3/4 bg-[var(--fg)] dark:bg-[color-mix(in_srgb,var(--fg)_92%,var(--bg))] rounded-lg" />
...
const ArdraFolder: React.FC<{
    ...
    return (
        <div className="relative">
            ...
            >
                <motion.div
                    className="w-10 h-10 rounded-full bg-[color-mix(in_srgb,var(--fg)_21%,var(--bg))]/50"
                    initial={{ scale: 1 }}
                    animate={
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
                {images.map((img, i) => (
                    <motion.img
                        ...
                        src={img}
                        alt=""
                        className="absolute w-10 h-10 object-cover rounded-full border-2 border-[var(--fg)] shadow-lg"
...
const HariFolder: React.FC<{
    ...
    return (
        <div className="relative">
            {/* Feedback Circle */}
            <motion.div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[color-mix(in_srgb,var(--fg)_55%,var(--bg))]"
            ...
            >
                ...
                {/* Paper Sheet Deco */}
                <div className="absolute bottom-0.5 left-0.5 right-0.5 h-3/4 bg-[var(--fg)]/80 rounded-lg" />
...
const RaviFolder: React.FC<{
    ...
    return (
        <div className="relative">
            {/* Feedback Circle */}
            <motion.div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[var(--fg)]"
                initial={{ opacity: 0, scale: 1 }}
                animate={
            ...
            <div className="relative cursor-pointer" style={{ perspective: "800px" }}>
                ...
                {/* Paper Sheet */}
                <div className="absolute bottom-0.5 left-0.5 right-0.5 h-3/4 bg-[var(--fg)] rounded-lg" />
...
const DurgaFolder: React.FC<{
    ...
    return (
        <div className="relative">
            ...
            <motion.div
                className="absolute -right-2 top-0 bg-[color-mix(in_srgb,var(--fg)_28%,var(--bg))] dark:bg-[color-mix(in_srgb,var(--fg)_21%,var(--bg))] rounded-lg px-3 py-2 shadow-lg z-20 min-w-[100px]"
            ...
            >
                {files.slice(0, 6).map((file, i) => (
                    <motion.div
                        key={i}
                        className="text-[color-mix(in_srgb,var(--fg)_97%,var(--bg))] font-mono text-xs py-0.5 whitespace-nowrap"
                        initial={{ opacity: 0 }}
...
const NandiFolder: React.FC<{
    ...
    const fileColorMap: Record<string, string> = {
        txt: "fill-[color-mix(in_srgb,var(--fg)_87%,var(--bg))]",
        gif: "fill-[color-mix(in_srgb,var(--fg)_71%,var(--bg))]",
        mp3: "fill-[color-mix(in_srgb,var(--fg)_71%,var(--bg))]",
        default: "fill-[color-mix(in_srgb,var(--fg)_71%,var(--bg))]",
    };
    ...
    return (
        <div className="relative">
            ...
            <motion.div
                className="absolute left-1/2 -translate-x-1/2 bg-[var(--fg)] dark:bg-[color-mix(in_srgb,var(--fg)_97%,var(--bg))] rounded-2xl shadow-xl z-20 p-3 grid grid-cols-3 gap-2"
            ...
            >
                {files.slice(0, 6).map((file, i) => (
                    <div key={i} className="text-center">
                        ...
                        />
                        <span className="text-[8px] text-[color-mix(in_srgb,var(--fg)_45%,var(--bg))] block mt-0.5 truncate max-w-[35px]">
                            {file.name}
                        </span>
                    </div>
                ))}
